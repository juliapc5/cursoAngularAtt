...
constructor(private http: HttpClient, private router: Router){
    ...
    signup(email: string, password: string){
        return this.http.post<AuthResponseData>(
            'https://identitytoolkit.googleapis.com/v1/accounts:signInWithPassword?key=AIzaSyDAHcSSHV3E2mbj6nS2CcE4Qrsg58D20MU', 
    ...
    login(email: string, password: string ){
        return this.http.post<AuthResponseData>(
            'https://identitytoolkit.googleapis.com/v1/accounts:signInWithCustomToken?key=AIzaSyDAHcSSHV3E2mbj6nS2CcE4Qrsg58D20MU',
        { email: email, password: password, returnSecureToken: true}
        )
